 ...
 * @author esh
 */
public class FrameEmployeeMaster extends javax.swing.JFrame {
     ...
     */
    public FrameEmployeeMaster() {
        initComponents();
    }

    public FrameEmployeeMaster(String LOCATIONID, String USERNAME) {
        initComponents();
        loadLocation();
    ...
    private void initComponents() {
        ...
        jLabelCivilSatats = new javax.swing.JLabel();
        ...
        jComboBoxDesignation.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "--SELECT--", "MANAGER", "ASST MANAGER", "CASHIER" }));
        jComboBoxDesignation.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jComboBoxDesignationActionPerformed(evt);
            }
        });
        jPanel1.add(jComboBoxDesignation, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 50, 207, 22));

        jLabel22.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel22.setText("NIC No *");
        jPanel1.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 100, -1, -1));
        ...
        jPanel1.add(jTextFieldNICno, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 100, 207, 22));

        jLabel23.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel23.setText(" Confirm NIC No *");
        jPanel1.add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 100, -1, -1));
        ...
        jPanel1.add(jTextFieldConfirmNIC, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 100, 207, 22));

        jLabel25.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel25.setText("Gender *");
        jPanel1.add(jLabel25, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 150, -1, -1));

        jLabel26.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel26.setText("Title *");
        jPanel1.add(jLabel26, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 150, -1, -1));
        ...
        jPanel1.add(jComboBoxTitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 150, 207, 22));
        ...
        jComboBoxCivilStatus.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "--SELECT--", "MARRIED", "SINGLE", "DIVORCE", "WIDOWED" }));
        jComboBoxCivilStatus.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jComboBoxCivilStatusActionPerformed(evt);
            }
        });
        jPanel1.add(jComboBoxCivilStatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 300, 207, 22));

        jLabel29.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel29.setText("Mobile No 1 *");
        jPanel1.add(jLabel29, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 300, -1, -1));
        ...
        jPanel1.add(jTextFieldMobile1, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 300, 207, 22));
        ...
        jPanel1.add(jTextFieldMobile2, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 350, 207, 22));

        jLabel30.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel30.setText("Mobile No 2");
        jPanel1.add(jLabel30, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 350, -1, -1));

        jLabel31.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel31.setText("Addres Line 1 *");
        jPanel1.add(jLabel31, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 350, -1, -1));
        ...
        jPanel1.add(jTextFieldAdd1, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 350, 207, 22));

        jLabel32.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel32.setText("Address Line 2 *");
        jPanel1.add(jLabel32, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 400, -1, -1));
        ...
        jPanel1.add(jTextFieldAdd2, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 400, 207, 22));

        jLabel33.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel33.setText("Address Line 3");
        jPanel1.add(jLabel33, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 400, -1, -1));
        ...
        jPanel1.add(jTextFieldAdd3, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 400, 207, 22));
        ...
        jTextFieldTelephone.addKeyListener(new java.awt.event.KeyAdapter() {
            ...
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTextFieldTelephoneKeyTyped(evt);
            }
        });
        jPanel1.add(jTextFieldTelephone, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 450, 207, 22));

        jLabel35.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel35.setText("Telephone *");
        jPanel1.add(jLabel35, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 450, -1, -1));

        jLabel15.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel15.setText("Designation");
        jPanel1.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 50, -1, -1));
        ...
        jPanel1.add(jButtonSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 500, 74, 30));
        ...
        jPanel1.add(jButtonUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 500, 74, 30));
        ...
        jPanel1.add(jCheckBoxInactive, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 503, -1, -1));
        ...
        jPanel1.add(jLabelGender, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 175, 200, 15));
        ...
        jLabelCivilSatats.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabelCivilSatats.setForeground(new java.awt.Color(255, 0, 51));
        jPanel1.add(jLabelCivilSatats, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 325, 200, 15));

        jLabelAdd2.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabelAdd2.setForeground(new java.awt.Color(255, 0, 51));
        jPanel1.add(jLabelAdd2, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 425, 200, 15));

        jLabelTelephone.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabelTelephone.setForeground(new java.awt.Color(255, 0, 51));
        jPanel1.add(jLabelTelephone, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 475, 200, 15));
        ...
        jPanel1.add(jLabelConfirmNIC, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 125, 200, 15));

        jLabelTitle.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabelTitle.setForeground(new java.awt.Color(255, 0, 51));
        jPanel1.add(jLabelTitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 175, 200, 15));
        ...
        jPanel1.add(jLabelmobile1, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 325, 200, 15));

        jLabelAdd1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabelAdd1.setForeground(new java.awt.Color(255, 0, 51));
        jPanel1.add(jLabelAdd1, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 375, 200, 15));

        jTextFieldGender.setEditable(false);
        jPanel1.add(jTextFieldGender, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 150, 207, 22));
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 500, 74, 26));
    ...
    private void jButtonSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSaveActionPerformed
        ...
        if (jTextFieldAdd1.getText().length() <= 0 || jTextFieldAdd2.getText().length() <= 0 || jTextFieldConfirmNIC.getText().length() <= 0 || jTextFieldFullName.getText().length() <= 0 || jTextAreaIntials.getText().length() <= 0 || jTextFieldMobile1.getText().length() <= 0
                || jTextFieldNICno.getText().length() <= 0 || jTextFieldTelephone.getText().length() <= 0 || jTextFieldDOB.getText().length() <= 0 
                || jComboBoxLocation.getSelectedIndex() == 0 || jComboBoxTitle.getSelectedIndex() == 0 || jComboBoxCivilStatus.getSelectedIndex() == 0
                || jTextFieldGender.getText().length() <= 1) {
            ...
            if (jTextFieldTelephone.getText().length() <= 0) {
                jLabelTelephone.setText("Required");
            }
            ...
            if (jComboBoxCivilStatus.getSelectedIndex() == 0) {
                jLabelCivilSatats.setText("Required");
            }
            ...
            if (s == JOptionPane.OK_OPTION) {
                ...
                e.insert();
                this.dispose();
                FrameEmployeeMaster em = new FrameEmployeeMaster();
                em.setVisible(true);
            }
    ...
    private void jTextFieldTelephoneKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldTelephoneKeyReleased
        ...
        String s = jTextFieldTelephone.getText();
        jTextFieldTelephone.setText(s.toUpperCase());

        jLabelTelephone.setText("");
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        ...
        if (jTextFieldAdd1.getText().length() <= 0 || jTextFieldAdd2.getText().length() <= 0 || jTextFieldConfirmNIC.getText().length() <= 0 || jTextFieldFullName.getText().length() <= 0 || jTextAreaIntials.getText().length() <= 0 || jTextFieldMobile1.getText().length() <= 0
                || jTextFieldNICno.getText().length() <= 0 || jTextFieldTelephone.getText().length() <= 0 || jTextFieldDOB.getText().length() <= 0 
                || jComboBoxLocation.getSelectedIndex() == 0 || jComboBoxTitle.getSelectedIndex() == 0 || jComboBoxCivilStatus.getSelectedIndex() == 0
                || jTextFieldGender.getText().length() <= 0) {
    ...
    private void jTextFieldTelephoneKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldTelephoneKeyTyped
        ...
        if (jTextFieldTelephone.getText().length() > 9) {
            evt.consume();
        }
    }//GEN-LAST:event_jTextFieldTelephoneKeyTyped
    ...
    private void jTextAreaIntialsKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextAreaIntialsKeyReleased
        ...
        if (c == KeyEvent.VK_TAB) {
            jComboBoxCivilStatus.grabFocus();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameEmployeeMaster.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameEmployeeMaster().setVisible(true);
            }
        });
    }
    ...
    public static javax.swing.JComboBox jComboBoxCivilStatus;
    public static javax.swing.JComboBox jComboBoxDesignation;
    ...
    private javax.swing.JLabel jLabelCivilSatats;
    ...
    public static javax.swing.JTextField jTextFieldTelephone;
